...
class RepoListAdapter(private val showFullName: Boolean = true, private val repoClickCallback: ((Repo) -> Unit)?): BaseRecyclerViewAdapter<Repo>(){
    ...
    class RepoItemViewHolder (override val containerView: View, private val showFullName:Boolean = true,
        ...
        BaseRecyclerViewAdapter.BaseViewHolder<Repo>(containerView), LayoutContainer {
